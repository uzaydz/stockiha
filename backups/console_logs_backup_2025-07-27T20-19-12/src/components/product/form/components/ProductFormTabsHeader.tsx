...
const ProductFormTabsHeader = memo<ProductFormTabsHeaderProps>(({
  ...
  return (
    <Card className="hidden lg:block p-6 bg-gradient-to-r from-background/95 via-background to-background/95 dark:from-background/90 dark:via-background dark:to-background/90 shadow-lg dark:shadow-2xl dark:shadow-black/20 backdrop-blur-sm border-border/50 transition-all duration-300">
      {/* Header Section */}
