  ...
  const faqs = [
    {
      ...
      questions: [
        {
          question: "ما هي منصة ستوكيها؟",
          answer: "ستوكيها هي منصة متكاملة لإدارة المتاجر تجمع بين نقطة البيع، المتجر الإلكتروني، إدارة المخزون، والتوصيل في نظام واحد سهل الاستخدام."
        },
        {
        ...
        },
        {
          ...
          answer: "نعم، منصة ستوكيها مصممة خصيصاً للسوق الجزائري وتدعم اللغة العربية والفرنسية بالكامل في جميع أجزاء النظام."
        }
      ]
    },
    {
