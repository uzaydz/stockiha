...
export async function processOrder(
  ...
  try {
    ...
    console.log("استدعاء process_online_order_new بالمعاملات:", params);
    ...
    if (error) {
      ...
      if (error.code === 'PGRST202') {
        console.log('محاولة استخدام الدالة القديمة process_online_order بدلاً من ذلك');
        ...
        console.log('محاولة استدعاء process_online_order بالمعاملات:', fallbackParams);
        ...
        try {
          ...
          console.log('نجح استدعاء process_online_order القديمة');
