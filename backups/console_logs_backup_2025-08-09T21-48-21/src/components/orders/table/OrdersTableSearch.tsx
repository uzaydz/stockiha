      ...
      <div className="mb-6 space-y-4">
        <div className="flex flex-col space-y-4 lg:flex-row lg:space-y-0 lg:space-x-4 lg:items-center lg:justify-between">
          <div className="relative flex items-center w-full lg:w-96">
            ...
            className="pl-10 pr-4 py-2.5 w-full rounded-lg border border-border/40 bg-background/70 focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all duration-200 text-foreground placeholder:text-muted-foreground"
              value={searchFilter}
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="bg-primary/10 border border-primary/30 px-4 py-2 rounded-lg text-sm flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" className="gap-2 px-4 py-2 rounded-lg border-border/40 bg-background/70 hover:bg-accent/50 hover:border-primary/30 transition-all duration-200">
