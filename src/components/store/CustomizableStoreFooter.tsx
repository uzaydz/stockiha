                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <Link 
                      key={index}
                      to={social.url} 
                      className="h-10 w-10 rounded-full bg-card hover:bg-primary/10 flex items-center justify-center text-muted-foreground hover:text-primary transition-colors border border-border/40 hover:border-primary/30"
                    >
