...
export const ProductSummary: React.FC<ProductSummaryProps> = React.memo(({
  ...
  // حساب السعر والصورة بناءً على اللون والمقاس المحددين
  let currentPrice = productDetails.price;
  let currentComparePrice = productDetails.compare_at_price;
  let currentImage = productDetails.thumbnail_image;
  let colorName = '';
  let sizeName = '';
  ...
  const originalPrice = hasDiscount ? currentComparePrice : null;
