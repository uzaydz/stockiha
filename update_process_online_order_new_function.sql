CREATE OR REPLACE FUNCTION public.process_online_order_new(
    p_full_name text, 
    p_phone text, 
    p_province text, 
    p_municipality text, 
...
BEGIN
  ...
  -- 4. إنشاء الطلب (مع إضافة عمود metadata)
  INSERT INTO online_orders (
    ...
    slug,
    shipping_option,
    -- إضافة عمود metadata إلى القائمة
    metadata 
  )
  VALUES (
    v_customer_id,
