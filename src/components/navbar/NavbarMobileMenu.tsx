          ...
          <ScrollArea className="flex-1">
            <div className="p-3 space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  <div 
                    className="flex items-center justify-between px-3 py-2 text-sm rounded-xl hover:bg-muted/60 transition-colors cursor-pointer"
                  ...
                  {activeSection === 'categories' && (
                    <div className="pr-3 pl-1 mr-4 border-r-2 border-primary/20 space-y-1.5 animate-in slide-in-from-left-5 duration-200">
                      {categories.length > 0 ? (
                        categories.map((category, i) => (
                          <Link 
                            key={i}
                            to={`/category/${category.id}`}
                            className="flex items-center justify-between p-2 text-sm rounded-lg hover:bg-primary/5 transition-colors"
                            onClick={handleClose}
                          >
                        ...
                        [
                          ...
                          { id: 'cat2', name: 'ألعاب فيديو' },
                          { id: 'cat3', name: 'أجهزة منزلية' },
                          { id: 'cat4', name: 'الموضة والأزياء' },
                        ].map((category, i) => (
                          <Link 
                            key={i}
                            to={`/category/${category.id}`}
