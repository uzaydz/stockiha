    ...
    <section ref={containerRef} className="relative min-h-screen overflow-hidden bg-gradient-to-br from-white dark:from-gray-900 via-white dark:via-gray-900 to-gray-50/20 dark:to-gray-800/20">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-radial from-[#fc5d41]/15 to-transparent rounded-full blur-3xl"
        />
        <motion.div
          animate={{ 
            scale: [1.05, 1, 1.05],
          ...
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-radial from-purple-500/15 to-transparent rounded-full blur-3xl"
        />
                  ...
                  <div className="flex">
                    {[...Array(5)].map((_, i) => (
                      <motion.div
                        ...
                        transition={{ delay: 2.6 + i * 0.1, type: "spring", stiffness: 200 }}
                      >
