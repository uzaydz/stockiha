...
export const useBannerData = (heroData?: HeroData) => {
  ...
  const processedData = useMemo(() => {
    ...
    return {
      ...
      selectedProducts: (currentHeroData as any).selectedProducts,
      showProducts: (currentHeroData as any).showProducts,
      productsDisplay: (currentHeroData as any).productsDisplay,
      productsLimit: (currentHeroData as any).productsLimit,
      productsType: (currentHeroData as any).productsType
    };
  }, [heroData, t, isRTL]);
