        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuItem 
              onClick={(e) => {
                e.stopPropagation()
                console.log('فتح الإعدادات للمكون:', component.id)
              }}
              className="gap-2"
            >
  ...
  const renderedComponent = useMemo(() => {
    ...
    switch (component.type) {
      ...
      case 'featured_products':
        content = (
          <FeaturedProducts 
            ...
            displayCount={component.settings.displayCount}
      ...
      case 'product_categories':
        console.log('🏷️ عرض ProductCategories مع الإعدادات:', component.settings);
        content = (
          <ProductCategories 
            title={component.settings.title}
            description={component.settings.description}
      ...
      case 'testimonials':
        console.log('💬 عرض CustomerTestimonials مع الإعدادات:', component.settings);
        content = (
      ...
      case 'about':
        console.log('📖 عرض StoreAbout مع الإعدادات:', component.settings);
        content = (
          <StoreAbout 
            title={component.settings.title}
...
export const StorePreview: React.FC<StorePreviewProps> = React.memo(({ organizationId }) => {
  ...
  const handleDeleteComponent = useCallback(async (id: string) => {
    try {
      ...
      if (error) {
        console.error('خطأ في حذف المكون من قاعدة البيانات:', error)
        toast({
          title: "خطأ في الحذف",
                    ...
                    <div className={cn(
                      ...
                      <div className="bg-gradient-to-r from-background/40 to-background/60 backdrop-blur-md rounded-full border border-border/20 shadow-lg px-2 py-1">
                        <div className="flex items-center gap-1 px-1">
                          ...
                          <a href="#" className="navbar-link group flex items-center gap-2 px-3 py-2 h-9 rounded-lg text-sm font-medium transition-all duration-300 hover:bg-primary/10 relative overflow-hidden text-foreground/90 hover:text-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-tag h-4 w-4 transition-colors duration-300 text-muted-foreground group-hover:text-primary">
                              <path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"></path>
                              <circle cx="7.5" cy="7.5" r=".5" fill="currentColor"></circle>
                            </svg>
                            <span className="text-sm font-medium group-hover:text-primary transition-colors duration-300">المنتجات</span>
                          </a>
                          <a href="#" className="navbar-link group flex items-center gap-2 px-3 py-2 h-9 rounded-lg text-sm font-medium transition-all duration-300 hover:bg-primary/10 relative overflow-hidden text-foreground/90 hover:text-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-settings h-4 w-4 transition-colors duration-300 text-muted-foreground group-hover:text-primary">
                          ...
                          <a href="#" className="navbar-link group flex items-center gap-2 px-3 py-2 h-9 rounded-lg text-sm font-medium transition-all duration-300 hover:bg-primary/10 relative overflow-hidden text-foreground/90 hover:text-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-truck h-4 w-4 transition-colors duration-300 text-muted-foreground group-hover:text-primary">
