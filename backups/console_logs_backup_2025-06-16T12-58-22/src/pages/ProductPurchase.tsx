...
const ProductPurchase = () => {
  ...
  console.log('🛍️ ProductPurchase - المنتج:', product);
  console.log('🎨 ProductPurchase - ألوان المنتج:', product?.colors);
  console.log('📏 ProductPurchase - مقاسات state:', sizes);
  console.log('🔧 ProductPurchase - use_sizes:', product?.use_sizes);
  console.log('🎯 ProductPurchase - selectedColor:', selectedColor);
