...
export const TenantProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    try {
      console.log('💾 [TenantContext-Auth] حفظ بيانات المؤسسة من AuthContext:', orgData.name);
      ...
      if (subdomain && subdomain !== 'main') {
        ...
        console.log('💾 [TenantContext-Auth] تم حفظ بيانات المتجر في session storage:', storeInfo);
      }
      ...
      console.log('🔔 [TenantContext-Auth] تم إطلاق حدث تحديث البيانات');
      
    } catch (error) {
      console.error('❌ [TenantContext-Auth] خطأ في حفظ بيانات المؤسسة:', error);
    }
    ...
    const delayedLoad = async () => {
      ...
      try {
        ...
        if (orgData) {
          ...
          try {
            console.log('💾 [TenantContext] حفظ بيانات المؤسسة في الكاش:', org.name);
            ...
            if (subdomain && subdomain !== 'main') {
              ...
              console.log('💾 [TenantContext] تم حفظ بيانات المتجر في session storage:', storeInfo);
            }
            ...
            console.log('🔔 [TenantContext] تم إطلاق حدث تحديث البيانات');
            
          } catch (error) {
            console.error('❌ [TenantContext] خطأ في حفظ بيانات المؤسسة:', error);
          }
