  ...
  return (
    <section className="relative w-full bg-background overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 navbar-spacer-lg pb-8 sm:navbar-spacer-lg sm:pb-10 md:navbar-spacer md:pb-8 lg:py-12">
        ...
        {/* شارات الثقة مع Lazy Loading */}
        {processedData.trustBadges && processedData.trustBadges.length > 0 && (
          <div className={cn(
            "mt-8 lg:mt-12",
            processedData.isRTL ? "text-center lg:text-start" : "text-center lg:text-end"
          )}>
            <TrustBadgesLazy 
              badges={processedData.trustBadges} 
              isRTL={processedData.isRTL} 
            />
          </div>
        )}
