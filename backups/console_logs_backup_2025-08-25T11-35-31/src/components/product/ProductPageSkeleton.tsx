...
const ProductPageSkeleton = memo(({ className, showInstantContent }: ProductPageSkeletonProps) => {
  return (
    <div className={cn("min-h-screen bg-background", className)}>
      <motion.div
        className="container mx-auto px-4 py-8"
        variants={containerVariants}
        initial={showInstantContent ? "visible" : "hidden"}
        animate="visible"
      >
