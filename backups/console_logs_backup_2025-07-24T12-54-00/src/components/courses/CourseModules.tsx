  ...
  const handleWatchCourse = (moduleId: number) => {
    ...
    if (courseSlug === 'e-commerce') {
      if (moduleId === 1) {
        ...
        console.log(`مشاهدة محور التجارة الإلكترونية رقم ${moduleId} - قريباً`);
      }
      return;
    }
    ...
    if (courseSlug === 'e-commerce-store') {
      console.log(`مشاهدة محور إنشاء المتجر رقم ${moduleId} - قريباً`);
      return;
    }
    ...
    if (courseSlug === 'tiktok-marketing') {
      if (moduleId === 0) {
        ...
        console.log(`مشاهدة محور تيك توك أدس رقم ${moduleId} - قريباً`);
      }
      return;
    }
    ...
    if (courseSlug === 'traditional-business') {
      console.log(`مشاهدة محور التجار التقليديين رقم ${moduleId} - قريباً`);
      return;
    }

    // Handle Service Providers course modules
    if (courseSlug === 'service-providers') {
      console.log(`مشاهدة محور مقدمي الخدمات رقم ${moduleId} - قريباً`);
      return;
    }
    ...
    if (moduleId === 1) {
      ...
      console.log(`مشاهدة المحور رقم ${moduleId} - قريباً`);
    }
  };
