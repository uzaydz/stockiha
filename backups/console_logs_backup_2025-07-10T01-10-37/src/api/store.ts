...
export async function processOrder(
  ...
  try {
    ...
    // استخدام دالة process_online_order المحدثة مباشرة
    const params = {
    ...
    console.log('Sending order parameters:', params);

    // استخدام "as any" لتجاوز تدقيق النوع في TypeScript
    const { data, error } = await supabaseClient.rpc('process_online_order', params as any);
