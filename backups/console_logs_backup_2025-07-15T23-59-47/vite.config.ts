    ...
    build: {
      ...
      rollupOptions: {
        ...
        output: {
          ...
          manualChunks: {
            ...
            // 📊 Heavy Features - تحميل عند الطلب فقط
            'vendor-heavy': [
              '@nivo/bar', '@nivo/line', '@nivo/pie', 'recharts',
              '@mui/material', '@mui/icons-material',
              '@monaco-editor/react', 'framer-motion'
            ],
      ...
      modulePreload: {
        ...
        resolveDependencies: (filename, deps) => {
          // تحميل vendor-core و vendor-ui فقط فوراً
