...
const ProductFormTabs = memo<ProductFormTabsProps>(({
  ...
  // Debug logging
  console.log('🔍 [ProductFormTabs] Debug data:');
  console.log('🔍 [ProductFormTabs] watchHasVariants:', watchHasVariants);
  console.log('🔍 [ProductFormTabs] productColors:', productColors);
  console.log('🔍 [ProductFormTabs] productColors.length:', productColors?.length || 0);
