...
const FAQItemComponent = ({ faq, isOpen, onClick, index }: FAQItemProps) => {
  return (
    ...
    >
      {/* Glow Effect */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#fc5d41]/20 to-[#e04e2f]/20 opacity-0 group-hover:opacity-100 rounded-3xl blur-xl transform scale-110 transition-opacity duration-500" />
      
      {/* Popular Badge */}
      {faq.popular && (
        <div className="absolute -top-3 -right-3 z-20">
          <Badge className="bg-[#fc5d41] text-[#fc5d41] border-0 text-xs font-medium px-3 py-1 shadow-lg">
      ...
      <div className={cn(
        ...
        isOpen 
          ? "border-[#fc5d41]/50 bg-gradient-to-br from-[#fc5d41]/10 to-[#fc5d41]/5 shadow-2xl shadow-[#fc5d41]/20" 
          : "border-border bg-card/50 hover:border-[#fc5d41]/30 hover:shadow-xl hover:bg-card/80"
      )}>
        {/* Background Pattern */}
        ...
        >
          <div className="flex-1 pr-4">
            <div className="flex items-start gap-4 mb-2">
              <div className="p-2 rounded-lg bg-[#fc5d41]/10 group-hover/button:bg-[#fc5d41]/20 transition-colors">
                <HelpCircle className="h-5 w-5 text-[#fc5d41]" />
              </div>
              <div className="flex-1">
                <h3 className="font-bold text-lg text-[#fc5d41] group-hover/button:text-[#fc5d41] transition-colors leading-relaxed">
                  {faq.question}
                </h3>
          ...
          <motion.div 
            ...
            className={cn(
              ...
              isOpen 
                ? "bg-[#fc5d41] text-[#fc5d41] shadow-[#fc5d41]/20" 
                : "bg-muted group-hover/button:bg-[#fc5d41] group-hover/button:text-[#fc5d41]"
            )}
          >
              ...
              <div className="px-8 pb-8">
                <div className="border-t border-border/50 pt-6">
                  <div className="flex items-start gap-4">
                    <div className="p-2 rounded-lg bg-[#fc5d41]/10">
                      <CheckCircle className="h-5 w-5 text-[#fc5d41] dark:text-[#e04e2f]" />
                    </div>
                    <div className="flex-1">
                      <motion.p 
                      ...
                      >
                        <Lightbulb className="h-4 w-4 text-[#fc5d41]" />
                        ...
                        <div className="flex gap-1">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <button key={star} className="hover:scale-110 transition-transform">
                              <Star className="h-4 w-4 text-[#fc5d41] hover:fill-[#fc5d41]" />
                            </button>
                          ))}
                        </div>
                      </motion.div>
...
const FAQSection = memo(() => {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative py-32 bg-gradient-to-br from-[#fc5d41]/5 dark:from-[#fc5d41]/10 overflow-hidden landing-section"
    >
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute top-1/4 -right-1/4 w-[600px] h-[600px] bg-gradient-radial from-[#fc5d41]/20 via-[#fc5d41]/5 to-transparent rounded-full blur-3xl"
        />
        <motion.div
          ...
          className="absolute bottom-1/4 -left-1/4 w-[800px] h-[800px] bg-gradient-radial from-[#fc5d41]/15 via-[#fc5d41]/5 to-transparent rounded-full blur-3xl"
        />
        ...
        {[...Array(8)].map((_, i) => (
          ...
          >
            <div className="w-6 h-6 bg-[#fc5d41]/20 rounded-full flex items-center justify-center">
              <HelpCircle className="w-4 h-4 text-[#fc5d41]/60" />
            </div>
          </motion.div>
        ))}
      </div>
      ...
      <div className="container px-6 mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-6xl font-bold text-[#fc5d41] mb-6">
            إجابات على <span className="bg-gradient-to-l from-[#fc5d41] via-[#e04e2f] to-[#ff7a5e] bg-clip-text text-transparent">جميع أسئلتك</span>
          </h2>
        ...
        >
          ...
          <div className="relative mb-8">
            ...
            <Input
              ...
              className="w-full h-14 pr-12 text-lg bg-card/50 backdrop-blur-sm border border-border rounded-2xl focus:border-[#fc5d41]/50 focus:ring-4 focus:ring-[#fc5d41]/10"
            />
          </div>
              ...
              <motion.button
                ...
                className={cn(
                  ...
                  selectedCategory === category
                    ? "bg-[#fc5d41] text-[#fc5d41] shadow-lg shadow-[#fc5d41]/20"
                    : "bg-card/50 text-muted-foreground hover:bg-[#fc5d41] hover:text-[#fc5d41] border border-border"
                )}
              >
                {category}
              </motion.button>
        ...
        >
          <div className="relative rounded-3xl border border-[#fc5d41]/30 bg-gradient-to-br from-[#fc5d41]/10 via-[#fc5d41]/50 to-[#fc5d41]/10 p-8 lg:p-12 shadow-2xl overflow-hidden">
            
            {/* Background Effects */}
            <div className="absolute inset-0 bg-gradient-to-br from-[#fc5d41]/5 to-[#fc5d41]/5" />
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-radial from-[#fc5d41]/20 to-transparent rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-radial from-[#fc5d41]/20 to-transparent rounded-full blur-2xl" />
            
            <div className="relative z-10 text-center">
              <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-[#fc5d41] to-[#fc5d41] mb-6">
                <Sparkles className="h-8 w-8 text-white" />
              </div>
              
              <h3 className="text-3xl font-bold text-[#fc5d41] mb-4">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <motion.div
                  ...
                  className="p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border hover:border-[#fc5d41]/30 transition-all duration-300"
                >
                  <Phone className="h-8 w-8 text-[#fc5d41] mx-auto mb-3" />
                  <h4 className="font-semibold text-[#fc5d41] mb-2">اتصل بنا</h4>
                ...
                <motion.div
                  ...
                  className="p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border hover:border-[#fc5d41]/30 transition-all duration-300"
                >
                  <Mail className="h-8 w-8 text-[#fc5d41] mx-auto mb-3" />
                  <h4 className="font-semibold text-[#fc5d41] mb-2">راسلنا</h4>
                ...
                <motion.div
                  ...
                  className="p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border hover:border-[#fc5d41]/30 transition-all duration-300"
                >
                  <MessageCircle className="h-8 w-8 text-[#fc5d41] mx-auto mb-3" />
                  <h4 className="font-semibold text-[#fc5d41] mb-2">دردشة مباشرة</h4>
