...
const CategoryCardOptimized = memo<CategoryCardProps>(({ 
  ...
  return (
    <Link 
      ...
      className="block group rounded-3xl overflow-hidden shadow-lg hover:shadow-xl border border-border/20 hover:border-primary/40 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-all duration-300 ease-out bg-gradient-to-b from-card/90 to-card/70 backdrop-blur-sm hover:from-card/95 hover:to-card/85 relative before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/5 before:to-transparent before:pointer-events-none"
        ...
        {showImages && (
          ...
          >
            {category.imageUrl ? (
              ...
              <>
                <div className="w-20 h-20 bg-white/25 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/20 group-hover:bg-white/35 group-hover:border-white/30 transition-all duration-300 shadow-lg">
                  <computedValues.IconComponent className="h-10 w-10 text-white drop-shadow-lg transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3" />
                </div>
        ...
        <div className="p-4 flex-1 flex flex-col justify-between bg-gradient-to-t from-background/50 to-transparent">
          ...
          <div className="relative overflow-hidden rounded-xl">
            <Button 
              variant="ghost" 
              size="sm" 
              className="w-full justify-between text-muted-foreground group-hover:text-white group-hover:bg-gradient-to-r group-hover:from-primary group-hover:via-primary group-hover:to-primary/90 transition-all duration-300 h-10 text-sm font-medium shadow-md border border-border/30 group-hover:border-primary/60 group-hover:shadow-lg backdrop-blur-md bg-gradient-to-r from-background/90 to-background/70 relative overflow-hidden group-hover:scale-105"
              tabIndex={-1}
            >
              {/* خلفية متدرجة */}
              ...
              <ArrowRight className="relative z-10 h-4 w-4 transform group-hover:translate-x-1 transition-all duration-300" />
            </Button>
          </div>
        </div>
      </motion.div>
