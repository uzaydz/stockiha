  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="اكتشف المميزات الفريدة التي تجعل منصة سطوكيها الخيار الأمثل لإدارة متجرك وتنمية تجارتك، من إدارة المخزون إلى متجرك الإلكتروني والعمل دون اتصال." />
      </Helmet>
