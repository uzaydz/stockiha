...
export function NavbarMain({
  ...
  // استخدام النظام المركزي للحصول على البيانات من localStorage
  const { storeName, logoUrl, isLoading: storeInfoLoading } = useStoreInfo();
  const { settings: organizationSettings, isLoading: settingsLoading } = useOrganizationSettings();
      ...
      <div className="flex items-center justify-between h-16 py-2 px-4 mx-auto w-full relative">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <div className="flex items-center gap-2">
            {/* مبدل اللغة - معطل لاستخدام لغة المؤسسة فقط */}
