...
const StoreHeader = ({
  ...
  const unreadNotifications = 3; // عدد الإشعارات غير المقروءة
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full right-0 mt-1 w-64 bg-background/95 backdrop-blur-lg shadow-lg rounded-lg border border-border/30 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                <div className="p-2">
                  <Link 
                    to="/products"
                    className="flex items-center gap-2 p-2 text-sm font-medium hover:bg-primary hover:text-primary-foreground rounded-md transition-all duration-200"
                  >
                    تصفح كل المنتجات
                  </Link>
          ...
          >
            ...
            {!isSearchOpen && (
              <Button 
                variant="ghost" 
                size="icon" 
                className="hidden md:flex h-10 w-10 hover:bg-primary hover:text-primary-foreground rounded-full transition-all duration-300 hover:scale-110"
            ...
            <Button variant="ghost" size="icon" className="relative h-10 w-10 hover:bg-primary hover:text-primary-foreground rounded-full transition-all duration-300 hover:scale-110">
              <ShoppingCart className="h-5 w-5" />
              {cartItemsCount > 0 && (
                <Badge className="absolute -top-2 -right-2 h-6 w-6 rounded-full p-0 text-xs flex items-center justify-center bg-primary text-primary-foreground">
                  {cartItemsCount}
                </Badge>
              )}
            </Button>
            ...
            <Button variant="ghost" size="icon" className="relative h-10 w-10 hover:bg-primary hover:text-primary-foreground rounded-full transition-all duration-300 hover:scale-110">
              ...
              {unreadNotifications > 0 && (
                <Badge className="absolute -top-2 -right-2 h-6 w-6 rounded-full p-0 text-xs flex items-center justify-center bg-red-500 text-white">
                  {unreadNotifications}
                </Badge>
              )}
            </Button>
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className="md:hidden h-10 w-10 hover:bg-primary hover:text-primary-foreground rounded-full transition-all duration-300 hover:scale-110">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 overflow-auto p-5">
                    <nav className="flex flex-col space-y-2">
                      <Link to="/" className="flex items-center gap-3 px-4 py-3 text-base font-medium hover:bg-primary hover:text-primary-foreground rounded-xl transition-all duration-300 group">
                      ...
                      <div className="flex flex-col">
                        <div 
                          className="flex items-center justify-between px-4 py-3 text-base font-medium hover:bg-primary hover:text-primary-foreground rounded-xl transition-all duration-300 group cursor-pointer"
