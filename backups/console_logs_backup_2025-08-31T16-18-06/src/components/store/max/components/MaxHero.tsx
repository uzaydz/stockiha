...
export const buttonStyles = {
  primary: "bg-primary text-primary-foreground hover:bg-primary-hover hover:text-primary-hover-foreground shadow-lg hover:shadow-xl transition-all duration-300",
  secondary: "bg-secondary text-secondary-foreground hover:bg-secondary-hover hover:text-secondary-hover-foreground shadow-lg hover:shadow-xl transition-all duration-300",
