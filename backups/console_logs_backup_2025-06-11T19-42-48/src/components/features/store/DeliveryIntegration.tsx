...
const DeliveryIntegration = () => {
  ...
  const features = [
    ...
    },
    {
      icon: MapPin,
      title: "تغطية واسعة",
      description: "وصول لمختلف مناطق المملكة عبر شبكة واسعة من شركات التوصيل المتكاملة",
      delay: 0.4
    }
  ];
      ...
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            قريباً، استمتع بتكامل سلس مع كبرى شركات التوصيل في المملكة، 
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              سنوفر تكاملاً مع العديد من شركات التوصيل الرائدة في المملكة
            </p>
          </div>
