  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        ...
        className="min-w-[180px] p-1 rounded-lg border shadow-lg will-change-transform"
        style={{ contain: 'layout paint', contentVisibility: 'auto' as any, transform: 'translateZ(0)' }}
      >
        {items ? items : (
