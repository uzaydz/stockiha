...
const SideMenu = ({ userRole, userPermissions }: SideMenuProps) => {
  ...
  const isInPOSPage = location.pathname === '/dashboard/pos-advanced' || location.pathname.startsWith('/dashboard/pos-advanced/');
                ...
                {!isInPOSPage && (
                  <button
                    ...
                    className={cn(
                      ...
                      "text-primary hover:text-primary hover:scale-105"
                    )}
