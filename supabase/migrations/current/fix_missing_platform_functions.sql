-- Fix missing platform functions
-- This migration adds the missing get_default_game_platform_css and get_default_game_platform_js functions
...
-- 3. Update the create_default_organization_settings function to handle display_text_with_logo
...
BEGIN
  INSERT INTO public.organization_settings (
    ...
    true, -- Show text with logo by default
    NOW(), NOW()
  )
