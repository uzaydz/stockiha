      ...
      <div className="container mx-auto px-4 py-16 md:py-20 lg:py-24">
        <div className="grid md:grid-cols-2 gap-10 md:gap-12 lg:gap-20 items-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            <div className="relative aspect-w-4 aspect-h-3 lg:aspect-w-5 lg:aspect-h-4 rounded-xl overflow-hidden shadow-2xl shadow-primary/10 border-4 border-background dark:border-gray-800/50 group-hover:scale-[1.02] transition-transform duration-500 ease-out">
              <img
