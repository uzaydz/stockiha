...
const PurchaseFormHeader: React.FC<PurchaseFormHeaderProps> = ({
  ...
  // استخدام النص المطلوب دائماً بدلاً من النص الممرر
  const defaultTitle = t('productActions.orderNow', 'اطلب الآن');
  const defaultDescription = t('productActions.completeOrder', 'إتمام الطلب');
