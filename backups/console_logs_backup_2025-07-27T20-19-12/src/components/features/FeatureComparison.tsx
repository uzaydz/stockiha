      ...
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            تجمع منصة سطوكيها بين مميزات متعددة لا توفرها الحلول الأخرى، مما يجعلها الخيار الأمثل لإدارة متجرك ونمو أعمالك.
          </p>
        </motion.div>
        ...
        >
          <div className="grid grid-cols-3">
            ...
            <div className="p-4 bg-primary/5 border-b border-r border-border">
                              <div className="font-bold text-primary">منصة سطوكيها</div>
            </div>
        ...
        >
          <p className="max-w-2xl mx-auto text-muted-foreground">
            منصة سطوكيها هي الحل الوحيد الذي يقدم منظومة متكاملة تجمع بين إدارة المتجر، المتجر الإلكتروني، السوق الإلكتروني، وإدارة الخدمات، مع ميزة فريدة للعمل دون اتصال.
          </p>
        </motion.div>
      </div>
    </section>
