-- =================================================================
-- 🎯 get_pos_orders_page_data_fixed - RPC مُصلح لصفحة طلبيات نقطة البيع
-- =================================================================
-- المؤلف: AI Assistant
-- التاريخ: 2025-01-27
...
DROP FUNCTION IF EXISTS public.get_pos_orders_page_data_fixed(UUID, UUID, INTEGER, INTEGER, JSONB, JSONB, JSONB);

CREATE OR REPLACE FUNCTION public.get_pos_orders_page_data_fixed(
    p_org_id UUID,
    p_user_id UUID,
...
COMMENT ON FUNCTION public.get_pos_orders_page_data_fixed IS 
