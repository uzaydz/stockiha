-- حذف جميع النسخ من الدالة وإعادة إنشاؤها
...
-- منح الأذونات للأدوار المختلفة
GRANT EXECUTE ON FUNCTION process_online_order_new(TEXT, TEXT, TEXT, TEXT, UUID, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, UUID, UUID, TEXT, INTEGER, NUMERIC, NUMERIC, NUMERIC, JSONB) TO anon;
GRANT EXECUTE ON FUNCTION process_online_order_new(TEXT, TEXT, TEXT, TEXT, UUID, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, UUID, UUID, TEXT, INTEGER, NUMERIC, NUMERIC, NUMERIC, JSONB) TO authenticated;
GRANT EXECUTE ON FUNCTION process_online_order_new(TEXT, TEXT, TEXT, TEXT, UUID, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, UUID, UUID, TEXT, INTEGER, NUMERIC, NUMERIC, NUMERIC, JSONB) TO service_role;
