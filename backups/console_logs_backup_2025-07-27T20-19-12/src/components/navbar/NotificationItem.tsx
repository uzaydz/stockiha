...
export function NotificationItem({ 
  ...
  const getNotificationIcon = (type: NotificationItemData['type']) => {
    switch (type) {
  ...
  const getPriorityStyles = (priority: NotificationItemData['priority']) => {
    switch (priority) {
      case 'urgent': 
        return {
  ...
  const getPriorityText = (priority: NotificationItemData['priority']) => {
    switch (priority) {
