...
export async function createSubscriptionTransaction(params: CreateSubscriptionTransactionParams) {
  try {
    ...
    console.error('Error in createSubscriptionTransaction:', error);
    throw error;
  }
}
...
export async function updateSubscriptionAccountInfo(params: UpdateAccountInfoParams) {
  try {
    ...
    console.error('Error in updateSubscriptionAccountInfo:', error);
    throw error;
  }
}
...
export async function deleteSubscriptionTransaction(transactionId: string) {
  try {
    ...
    if (error) {
      console.error('Error deleting subscription transaction:', error);
    ...
    console.error('Error in deleteSubscriptionTransaction:', error);
    throw error;
  }
}
...
export async function getSubscriptionTransactions(organizationId: string) {
  try {
    ...
    console.error('Error in getSubscriptionTransactions:', error);
    throw error;
  }
}
...
export async function getSubscriptionTransactionsStats(organizationId: string) {
  try {
    ...
    if (error) {
      console.error('Error fetching subscription transactions stats:', error);
      throw new Error(error.message);
    }
    ...
    console.error('Error in getSubscriptionTransactionsStats:', error);
    throw error;
  }
} 