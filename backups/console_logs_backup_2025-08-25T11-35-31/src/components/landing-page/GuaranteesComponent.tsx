...
interface GuaranteesComponentProps {
  settings: {
    title?: string;
    subtitle?: string;
...
const GuaranteesComponent: React.FC<GuaranteesComponentProps> = ({ 
  settings, 
  className = '' 
}) => {
  const { 
...
export default GuaranteesComponent;
