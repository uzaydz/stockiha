...
const Categories = () => {
  ...
  const refreshCategories = async () => {
    try {
      ...
      console.log('🔄 [Categories] Force refreshing categories after operation...');
      ...
      // استخدام forceDataRefresh لتجاوز جميع قيود UltimateRequestController
      ...
      console.log('✅ [Categories] Categories refreshed successfully:', categoriesData?.length || 0);
