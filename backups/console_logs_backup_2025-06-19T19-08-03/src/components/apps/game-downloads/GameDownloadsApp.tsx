      ...
      <div className="flex items-center justify-between pb-6 border-b">
        ...
        <Button 
          onClick={() => {
            ...
            console.log('Stored subdomain:', localStorage.getItem('bazaar_current_subdomain'));
            ...
            if (currentHostname.includes('.localhost') && !currentHostname.startsWith('localhost')) {
              ...
              console.log('Already on subdomain, using /games');
              ...
              if (!subdomain) {
                ...
                console.log('No subdomain found, using default: testfinalfinalvhio');
              }
              
              const port = currentPort ? `:${currentPort}` : '';
              const gamesUrl = `${currentProtocol}//${subdomain}.localhost${port}/games`;
              console.log('Redirecting to:', gamesUrl);
              window.open(gamesUrl, '_blank');
            }
          }}
          variant="outline"
