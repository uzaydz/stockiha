-- Add form_data column to online_orders table
-- هذا الترحيل يضيف عمود لحفظ بيانات النموذج المدخلة بتنسيق JSON

-- إضافة عمود form_data إلى جدول online_orders
ALTER TABLE online_orders
ADD COLUMN IF NOT EXISTS form_data JSONB DEFAULT NULL;

-- تحديث دالة process_online_order_new لتضمين بيانات النموذج
...
-- إضافة عمود municipality إلى جدول addresses إذا لم يكن موجوداً
