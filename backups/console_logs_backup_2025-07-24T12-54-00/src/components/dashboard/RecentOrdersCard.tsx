          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground mb-2">
              <div className="flex items-center gap-1">
                ...
                <span>{formatDate((order as any).created_at || order.createdAt)}</span>
              </div>
              <div className="flex items-center gap-1">
                <Clock className="h-3 w-3" />
                <span>{formatTime((order as any).created_at || order.createdAt)}</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              <div className="flex items-center gap-1 bg-muted/40 px-2 py-0.5 rounded-md">
                ...
                <span className="text-muted-foreground">
                  {(order as any).customer_name || 'زائر'}
                </span>
              </div>
