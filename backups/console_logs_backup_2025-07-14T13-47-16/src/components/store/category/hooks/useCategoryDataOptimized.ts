...
export const useCategoryDataOptimized = ({
  ...
  console.log('🔍 [useCategoryDataOptimized] Debug info:', {
  ...
  const processedCategories = useMemo(() => {
    ...
    if (categoriesToProcess.length === 0) {
      console.log('⚠️ [useCategoryDataOptimized] No categories to process');
      return [];
    }
    
    console.log('✅ [useCategoryDataOptimized] Processing categories:', categoriesToProcess.length);
  ...
  useEffect(() => {
    const timeoutId = setTimeout(() => {
      ...
      console.log('🔄 [useCategoryDataOptimized] Updating categories state:', {
  ...
  console.log('📋 [useCategoryDataOptimized] Final result:', {
