...
const ProductImageGalleryV2 = memo<ProductImageGalleryV2Props>(({ 
  ...
  useEffect(() => {
    ...
    // تحديث الصورة النشطة فقط إذا كان هناك لون محدد مع صورة صالحة
    // وفقط إذا كانت مختلفة عن الحالية
    if (newActiveImage && newActiveImage !== activeImage && allImages.includes(newActiveImage)) {
