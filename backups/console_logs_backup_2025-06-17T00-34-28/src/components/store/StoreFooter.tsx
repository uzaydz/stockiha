        ...
        <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-6 lg:col-span-4">
            ...
            <div className="flex items-center gap-3 mb-8">
                ...
                <Link to={socialLinks.facebook} className="h-10 w-10 rounded-full bg-card hover:bg-primary flex items-center justify-center text-muted-foreground hover:text-primary-foreground transition-colors border border-border/40 hover:border-primary/30">
                    <Facebook className="h-5 w-5" />
                </Link>
                )}
                {socialLinks.twitter && (
                <Link to={socialLinks.twitter} className="h-10 w-10 rounded-full bg-card hover:bg-primary flex items-center justify-center text-muted-foreground hover:text-primary-foreground transition-colors border border-border/40 hover:border-primary/30">
                    <Twitter className="h-5 w-5" />
                </Link>
                )}
                {socialLinks.instagram && (
                <Link to={socialLinks.instagram} className="h-10 w-10 rounded-full bg-card hover:bg-primary flex items-center justify-center text-muted-foreground hover:text-primary-foreground transition-colors border border-border/40 hover:border-primary/30">
                    <Instagram className="h-5 w-5" />
                </Link>
                )}
                {socialLinks.youtube && (
                <Link to={socialLinks.youtube} className="h-10 w-10 rounded-full bg-card hover:bg-primary flex items-center justify-center text-muted-foreground hover:text-primary-foreground transition-colors border border-border/40 hover:border-primary/30">
