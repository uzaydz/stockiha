...
const ProductFormTabContent = memo<ProductFormTabContentProps>(({
  ...
  useEffect(() => {
    console.log('🔍 [ProductFormTabContent] Variants tab rendering:');
    console.log('🔍 [ProductFormTabContent] watchHasVariants:', watchHasVariants);
    console.log('🔍 [ProductFormTabContent] productColors:', productColors);
    console.log('🔍 [ProductFormTabContent] productColors.length:', productColors?.length || 0);
  }, [watchHasVariants, productColors]);

  // Additional logging for variants tab visibility
  useEffect(() => {
    if (watchHasVariants) {
      console.log('🔍 [ProductFormTabContent] Variants tab should be visible');
      console.log('🔍 [ProductFormTabContent] Product colors available:', productColors?.length || 0);
    } else {
      console.log('🔍 [ProductFormTabContent] Variants tab should NOT be visible (watchHasVariants is false)');
    }
  }, [watchHasVariants, productColors]);
