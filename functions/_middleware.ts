...
function getSecurityHeaders(nonce: string): Record<string, string> {
  return {
    ...
    'Content-Security-Policy': [
      "default-src 'self'",
      `script-src 'self' 'nonce-${nonce}' 'sha256-vRKmGhO0Jt0ZJLajz37rSXGS0J2GkdjuvALzlXD9Ymg=' 'sha256-HEP/a7uzebOhHt9bVmS6zyymv90YmGWEAkZHYjfdd6g=' 'sha256-oToowZlM1h/gvo9UizVDTa7MltyVSmKouu4seQ8jBtw=' 'sha256-gkpPSL93wBndrOdeNSZNvORHPYYQJFZFeuGGo/EZIOI=' https://connect.facebook.net https://www.googletagmanager.com https://www.google-analytics.com https://js.sentry-cdn.com https://static.cloudflareinsights.com https://www.gstatic.com https://www.google.com`,
