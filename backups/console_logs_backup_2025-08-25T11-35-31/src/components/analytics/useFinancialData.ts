    ...
    queryFn: async (): Promise<FinancialData> => {
      ...
      if (!data || data.length === 0) {
        ...
        return {
          ...
          // الحقول الجديدة
          service_bookings_revenue: 0,
          service_bookings_profit: 0,
          service_bookings_count: 0,
          currency_sales_revenue: 0,
          currency_sales_profit: 0,
          currency_sales_count: 0,
          flexi_sales_revenue: 0,
          flexi_sales_profit: 0,
          flexi_sales_count: 0,
          detailed_breakdown: null,
          top_pos_products: [],
          top_online_products: [],
          pos_orders_stats: null,
          online_orders_stats: null
        };
      }
...
export const useChartData = (financialData: FinancialData | undefined) => {
  ...
  const salesData = financialData ? [
    ...
    { 
      name: 'حجوزات الخدمات', 
      value: financialData.service_bookings_revenue || 0, 
      profit: financialData.service_bookings_profit || 0 
    },
    { 
      name: 'بيع العملات', 
      value: financialData.currency_sales_revenue || 0, 
      profit: financialData.currency_sales_profit || 0 
    },
    { 
      name: 'مبيعات فليكسي', 
      value: financialData.flexi_sales_revenue || 0, 
      profit: financialData.flexi_sales_profit || 0 
    }
