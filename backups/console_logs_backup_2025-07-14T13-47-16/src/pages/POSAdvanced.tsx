  ...
  const handleSubmitOrder = useCallback(async (
    ...
    try {
      ...
      const subscriptionsTotal = selectedSubscriptions.reduce((total, subscription) => {
        ...
        console.log('🔍 [POSAdvanced] حساب سعر الاشتراك:', {
      ...
      console.log('🔍 [POSAdvanced] حساب المجموع:', {
        cartSubtotal,
        servicesTotal,
        subscriptionsTotal,
        subtotal
      ...
      console.log('🔍 [POSAdvanced] معاملات الدفع الجزئي:', {
        paidAmount,
        finalTotal,
        remainingAmount,
        ...
        isPartialPayment,
        amountPaid,
        willCreatePartialPayment: (isActualPartialPayment && considerRemainingAsPartial)
      });
      ...
      console.log('🔍 [POSAdvanced] بيانات الطلب النهائية:', {
