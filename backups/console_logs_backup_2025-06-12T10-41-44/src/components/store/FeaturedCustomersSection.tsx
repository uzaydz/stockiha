...
const defaultCustomers: FeaturedCustomer[] = [
  {
    ...
    story: "كنت أبحث عن منتجات تقنية عالية الجودة في الجزائر، وقد وفر لي المتجر كل ما أحتاجه بأسعار معقولة وخدمة ممتازة.",
    testimonial: "منتجات ذات جودة استثنائية وموثوقية عالية. أنصح بشدة بالتعامل مع هذا المتجر لكل من يبحث عن الأفضل في الجزائر.",
    socialMedia: {
      instagram: "@samir_tech_dz",
      twitter: "@samirtech_dz"
    }
  },
  {
    id: "2",
    name: "ليلى محمد زهراني",
    image: "https://images.unsplash.com/photo-1494790108755-2616b612b412?w=300&h=300&fit=crop&crop=face",
    occupation: "مصممة جرافيك",
    story: "بصفتي مصممة في الجزائر، أحتاج إلى منتجات ذات أداء عالي. وجدت ضالتي في هذا المتجر الذي يقدم منتجات تلبي متطلباتي المهنية.",
    testimonial: "الجودة والاحترافية هي أفضل ما يميز هذا المتجر. لقد ساعدتني منتجاتهم على تطوير أعمالي بشكل كبير.",
    socialMedia: {
      instagram: "@leila_designs_dz",
      facebook: "leiladesigns_algerie"
    }
  },
  {
    id: "3",
    name: "أحمد العمري بوضياف",
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&crop=face",
    occupation: "طبيب",
    story: "رغم انشغالي الدائم في المستشفى، استطعت الحصول على كل ما أحتاجه من هذا المتجر بسهولة ويسر. التوصيل السريع في الجزائر والخدمة الممتازة جعلتني زبونًا دائمًا.",
    testimonial: "المتجر يقدم خدمة استثنائية من حيث سرعة التوصيل وجودة المنتجات. تجربة شراء ممتازة من الألف إلى الياء.",
    socialMedia: {
      twitter: "@dr_ahmed_dz",
      facebook: "drahmed_algerie"
    }
  }
];
