    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-1/4 -left-1/4 w-[600px] h-[600px] bg-gradient-radial from-[#fc5d41]/15 via-[#fc5d41]/5 to-transparent rounded-full blur-3xl"
        />
        <motion.div
          ...
          className="absolute bottom-1/4 -right-1/4 w-[800px] h-[800px] bg-gradient-radial from-[#fc5d41]/10 via-[#fc5d41]/5 to-transparent rounded-full blur-3xl"
        />
        ...
        {[...Array(8)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-1.5 h-1.5 bg-[#fc5d41]/10 rounded-full blur-sm"
            initial={{
      ...
      <div className="container px-6 mx-auto relative z-10">
        ...
        >
          ...
          >
            <Badge 
              variant="outline" 
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#fc5d41]/5 text-[#fc5d41] border-[#fc5d41]/20 hover:bg-[#fc5d41]/10 transition-colors rounded-full mb-6"
            >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground mb-6 leading-tight">
            ...
            <span className="relative inline-block">
              <span className="bg-gradient-to-r from-[#fc5d41] via-[#fc5d41]/80 to-[#fc5d41] bg-clip-text text-transparent">متجرك بنجاح</span>
              <motion.span
                className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-[#fc5d41]/50 to-[#fc5d41]/50 rounded-full"
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
              ...
              <motion.button
                ...
                className={cn(
                  ...
                  activeSystem === system.id 
                    ? "bg-[#fc5d41] text-white shadow-lg shadow-[#fc5d41]/25"
: "bg-white dark:bg-gray-800/80 hover:bg-white dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white border border-gray-200 dark:border-gray-700/50 hover:border-[#fc5d41]/30"
                )}
              >
                ...
                {activeSystem === system.id && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-[#fc5d41]/5 rounded-xl md:rounded-2xl -z-10"
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-lg md:text-xl text-[#fc5d41] font-medium">{activeFeature.subtitle}</p>
                  </div>
                </motion.div>
                  ...
                  {activeFeature.features.map((feature, index) => (
                    ...
                    >
                      ...
                      <div className="relative flex items-start gap-3 md:gap-4">
                        <motion.div 
                          className="p-2 rounded-lg bg-[#fc5d41]/10 group-hover:bg-[#fc5d41]/20 transition-colors"
                          animate={{ rotate: hoveredFeature === index ? 360 : 0 }}
                          transition={{ duration: 0.5 }}
                        >
                          <feature.icon className="h-4 w-4 md:h-5 md:w-5 text-[#fc5d41]" />
                        </motion.div>
                        <div>
                          <h4 className="font-semibold text-sm md:text-base text-gray-900 dark:text-white mb-1 group-hover:text-[#fc5d41] transition-colors">
                            {feature.title}
                          </h4>
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                  ...
                  >
                    <h4 className="font-semibold text-sm md:text-base text-foreground flex items-center gap-2">
                      <BarChart3 className="h-4 w-4 md:h-5 md:w-5 text-[#fc5d41]" />
                      إحصائيات مبهرة
                    </h4>
