-- =============================================================================
-- نظام إدارة مخزون المتغيرات المتقدم
...
DROP FUNCTION IF EXISTS get_variant_inventory_summary(uuid, uuid);
...
DROP FUNCTION IF EXISTS get_inventory_variants_log(uuid, uuid, uuid);
...
GRANT EXECUTE ON FUNCTION update_variant_inventory(UUID, UUID, UUID, INTEGER, TEXT, TEXT, UUID) TO authenticated;
...
COMMENT ON FUNCTION update_variant_inventory IS 'تحديث مخزون المتغيرات مع مزامنة تلقائية لجميع المستويات';
