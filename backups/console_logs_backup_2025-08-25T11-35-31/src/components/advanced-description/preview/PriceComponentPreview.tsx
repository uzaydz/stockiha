...
interface PriceComponentPreviewProps {
...
export const PriceComponentPreview: React.FC<PriceComponentPreviewProps> = ({
  component,
  onEdit,
  onDelete,
  onMoveUp,
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-sm">سعر المنتج</CardTitle>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
                  سيتم عرض سعر المنتج الحالي تلقائياً مع جميع التفاصيل:
