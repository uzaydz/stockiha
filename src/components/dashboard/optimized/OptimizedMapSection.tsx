      ...
      <div className="space-y-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-bold text-foreground">خريطة توزيع الطلبات</h2>
            <p className="text-sm text-muted-foreground">عرض مرئي تفاعلي للطلبات الأونلاين حسب الولايات</p>
          </div>
        </div>
