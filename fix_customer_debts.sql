...
-- 4. تعديل وظيفة get_partial_payments_summary لتشمل جميع الطلبات ذات المبالغ المتبقية
...
-- 5. تعديل وظيفة get_debts_by_customer لتشمل جميع الطلبات ذات المبالغ المتبقية
...
-- 6. تعديل وظيفة get_customer_debts لتشمل جميع الطلبات ذات المبالغ المتبقية
...
-- 7. حذف وظيفة record_payment_transaction القديمة
DROP FUNCTION IF EXISTS record_payment_transaction(UUID, DECIMAL, TEXT, BOOLEAN, BOOLEAN);

-- 8. إصلاح وظيفة record_payment_transaction للتعامل بشكل صحيح مع الدفعات المتتالية
