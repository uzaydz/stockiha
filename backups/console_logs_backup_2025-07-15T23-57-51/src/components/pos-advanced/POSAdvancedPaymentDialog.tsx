...
const POSAdvancedPaymentDialog: React.FC<POSAdvancedPaymentDialogProps> = ({
  ...
  // حساب المبالغ - تم تبسيطه بعد إزالة التخفيضات
  ...
  useEffect(() => {
    if (isOpen) {
      setAmountPaid(''); // تعيين فارغ بدلاً من المبلغ الكامل للسماح بإدخال أي مبلغ
  ...
  const handlePaymentComplete = () => {
    ...
    onPaymentComplete({
      ...
      notes,
      discount: 0, // تم إزالة التخفيضات
      discountType: 'fixed', // تم إزالة التخفيضات
