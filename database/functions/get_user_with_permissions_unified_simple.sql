-- =====================================================
-- دالة RPC موحدة مبسطة للتعرف على المستخدم والصلاحيات
-- الإصدار المبسط - يتعامل فقط مع الأعمدة الموجودة
-- =====================================================
...
'دالة RPC موحدة مبسطة للحصول على بيانات المستخدم والصلاحيات - الإصدار 2.2.0.
تتعامل فقط مع الأعمدة الموجودة في جدول users.
