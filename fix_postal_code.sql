-- 1. تعديل جدول العناوين للسماح بقيمة فارغة للرمز البريدي أو تعيين قيمة افتراضية
ALTER TABLE addresses 
  ALTER COLUMN postal_code DROP NOT NULL,
  ALTER COLUMN postal_code SET DEFAULT '00000';

-- أو جعل القيمة الافتراضية فارغة إذا كان ذلك ممكنًا
-- ALTER TABLE addresses 
--   ALTER COLUMN postal_code DROP NOT NULL,
--   ALTER COLUMN postal_code SET DEFAULT '';

-- 2. تحديث وظيفة process_online_order_new لإضافة الرمز البريدي بشكل صريح
...
BEGIN
  ...
  -- 2. إنشاء عنوان جديد للطلب - مع إضافة الرمز البريدي
  INSERT INTO addresses (
    ...
    country,
    organization_id,
    postal_code  -- تمت إضافة الرمز البريدي
  )
  VALUES (
    v_customer_id,
    p_full_name,
