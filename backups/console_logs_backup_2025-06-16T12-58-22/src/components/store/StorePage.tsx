                      ...
                      <LazyLoad key={component.id || `component-${index}`}>
                        ...
                        {(component.type === 'featured_products' || component.type === 'featuredproducts') && (
                          (() => {
                            ...
                            console.log('🏪 StorePage - تحويل المنتجات المميزة:', {
                              originalCount: storeData?.featured_products?.length || 0,
                              convertedCount: convertedProducts.length,
                              firstProduct: convertedProducts[0] ? {
                                name: convertedProducts[0].name,
                                imageUrl: convertedProducts[0].imageUrl,
                                hasImage: !!convertedProducts[0].imageUrl
                              } : null
                            });
