...
import './BeforeAfterComponentEditor.css';
...
const BeforeAfterComponentEditor: React.FC<BeforeAfterComponentEditorProps> = ({ 
  ...
  return (
    <div className="before-after-editor h-full flex flex-col space-y-2 w-full">
      <div className="w-full flex-1 flex flex-col">
        ...
        >
          ...
          <TabsContent value="general" className="flex-1 min-h-0 h-full flex flex-col overflow-hidden">
            <div className="flex-1 overflow-y-auto overflow-x-hidden min-h-0 max-h-full" style={{ minHeight: 0, maxHeight: '100%' }}>
          ...
          <TabsContent value="items" className="relative h-full flex flex-col">
            <Card className="border shadow-sm h-full flex flex-col">
              <CardHeader className="px-3 py-2 border-b flex flex-row items-center justify-between flex-shrink-0">
                <CardTitle className="text-xs font-medium flex items-center gap-1.5">
