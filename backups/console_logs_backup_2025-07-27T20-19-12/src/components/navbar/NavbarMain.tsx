...
export function NavbarMain({
      ...
      try {
        ...
        if (appInitData) {
          ...
          if (data?.organization?.settings) {
            ...
            console.log('✅ [NavbarMain] جلب البيانات من localStorage:', {
              logo: settings.logo_url,
              siteName: settings.site_name || data.organization.name
            });
          }
        }
        ...
        if (!storeInfo && currentOrganization?.id) {
          console.log('🔄 [NavbarMain] إعادة تهيئة النظام...');
        ...
        console.error('❌ [NavbarMain] خطأ في جلب البيانات الاحتياطية:', error);
      }
    };
  ...
  useEffect(() => {
    console.log('🔍 [NavbarMain] البيانات المتاحة:', {
      storeInfo,
      storeName,
      logoUrl,
      organizationSettings,
      organizationSettingsFromProduct,
      finalOrganizationSettings,
      orgLogo,
      siteName,
  ...
  useEffect(() => {
    if (finalOrganizationSettings) {
      console.log('✅ [NavbarMain] البيانات النهائية:', {
        orgLogo,
        siteName,
        displayTextWithLogo,
        hasLogo: !!orgLogo,
        logoLength: orgLogo?.length
      });
    } else {
      console.log('⚠️ [NavbarMain] لا توجد إعدادات نهائية');
    }
