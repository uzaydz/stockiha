...
const ConversionTrackingTab: React.FC<ConversionTrackingTabProps> = ({ form, organizationId, productId }) => {
  ...
  const watchedValues = watch([
    ...
    'marketingSettings.tiktok_events_api_enabled'
  ]);

  const [isTestMode, facebookEnabled, googleEnabled, tiktokEnabled, facebookApiEnabled, tiktokApiEnabled] = watchedValues;

  // إجبار إعادة الرسم عند تغيير أي قيمة
  useEffect(() => {
    setForceUpdate(prev => prev + 1);
  }, [isTestMode, facebookEnabled, googleEnabled, tiktokEnabled, facebookApiEnabled, tiktokApiEnabled]);
              ...
              {tiktokEnabled && (
                <div className="space-y-4 animate-in slide-in-from-top-2 duration-300">
                  ...
                  <div className="space-y-4">
                      <FormField
                        control={control}
                        name="marketingSettings.tiktok_events_api_enabled"
                        render={({ field }) => (
                          <FormItem>
                          <div className="flex items-center justify-between p-3 bg-green-50/50 dark:bg-green-950/20 rounded-lg border border-green-200/50 dark:border-green-800/30">
                            <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-green-900 dark:text-green-100">
                  ...
                  {(facebookApiEnabled || tiktokApiEnabled) && ' + Conversion API'}
                </p>
                <p className="text-xs text-green-700 dark:text-green-300">
