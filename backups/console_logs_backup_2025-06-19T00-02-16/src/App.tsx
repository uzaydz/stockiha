...
if (import.meta.env.DEV) {
  ...
  console.log('🛠️ [DEV] تطوير: دوال التحديث السريع متاحة:');
  console.log('- forceRefreshAfterMutation(dataType, operation)');
  console.log('- refreshProducts(), refreshCategories(), refreshOrders()');
  console.log('- refreshInventory(), refreshAll()');
}
