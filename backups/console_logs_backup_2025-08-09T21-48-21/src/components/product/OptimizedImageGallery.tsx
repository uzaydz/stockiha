...
// مكون محسن للغاية للهواتف - بدون framer-motion
const OptimizedImageGallery = memo<OptimizedImageGalleryProps>(({ 
  product, 
  selectedColor,
  className
}) => {
  ...
  }, [touchStart, touchEnd, images.length, isMobile, isTransitioning]);
  ...
  const handleImageError = useCallback(() => {
    setIsImageLoaded(true); // حتى لو فشلت، اعتبرها محملة لتجنب التعليق
  }, []);
