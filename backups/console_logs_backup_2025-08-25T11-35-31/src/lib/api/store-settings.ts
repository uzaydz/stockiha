...
export const updateStoreSettings = async (
  ...
  try {
    ...
    console.error('فشل في تحديث إعدادات المتجر:', error);
    return null;
  }
};
...
export const getOrganizationTheme = async (organizationId: string): Promise<ThemeSettingsResponse | null> => {
  try {
    ...
    console.error('فشل في جلب إعدادات الثيم:', error);
    return null;
  }
};
...
export const applyThemeSettings = async (theme: ThemeSettingsResponse['theme']) => {
  ...
  try {
    ...
    console.error('خطأ في تطبيق إعدادات الثيم:', error);
  }
};
...
export const exportStoreSettings = async (organizationId: string): Promise<string | null> => {
  try {
    ...
    console.error('فشل في تصدير إعدادات المتجر:', error);
    return null;
  }
};
...
export const importStoreSettings = async (
  ...
  try {
    ...
    console.error('فشل في استيراد إعدادات المتجر:', error);
    return {
      success: false,
