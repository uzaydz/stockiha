...
interface QuantityComponentPreviewProps {
...
export const QuantityComponentPreview: React.FC<QuantityComponentPreviewProps> = ({
  component,
  onEdit,
  onDelete,
  onMoveUp,
            ...
            <div className="text-center space-y-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground px-4">
                  سيظهر محدد كمية المنتج مع أزرار الزيادة والنقصان
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
                  سيتم عرض محدد كمية المنتج مع جميع الميزات:
                  أزرار الزيادة والنقصان، إدخال الكمية يدوياً، والحد الأدنى والأعلى للكمية.
                </p>
              </div>
            </div>
          </div>
