    ...
    try {
      ...
      if (data && data.livraison && Array.isArray(data.livraison) && data.livraison.length > 0) {
        ...
        if (wilayaRate) {
          ...
          console.log('⚠️ [calculateEcotrackShippingPrice] لم نجد الولاية، استخدام السعر الافتراضي:', {
            deliveryType,
            wilayaId,
      ...
      if (data.success && data.data && data.data.length > 0) {
        ...
        console.log('✅ [calculateEcotrackShippingPrice] السعر المحسوب (البنية القديمة):', {
          deliveryType,
