...
export const useSmartDataRefresh = () => {
  ...
  const refreshProducts = useCallback(async (options: SmartRefreshOptions = {}) => {
    ...
    console.log('🔄 [SmartRefresh] Refreshing products...');
    ...
    console.log('✅ [SmartRefresh] Products refreshed');
  }, [queryClient]);
  ...
  const refreshCategories = useCallback(async (options: SmartRefreshOptions = {}) => {
    ...
    console.log('🔄 [SmartRefresh] Refreshing categories...');
    ...
    console.log('✅ [SmartRefresh] Categories refreshed');
  }, [queryClient]);
  ...
  const refreshInventory = useCallback(async (options: SmartRefreshOptions = {}) => {
    ...
    console.log('🔄 [SmartRefresh] Refreshing inventory...');
    ...
    console.log('✅ [SmartRefresh] Inventory refreshed');
  }, [queryClient]);
  ...
  const refreshOrders = useCallback(async (options: SmartRefreshOptions = {}) => {
    ...
    console.log('🔄 [SmartRefresh] Refreshing orders...');
    ...
    console.log('✅ [SmartRefresh] Orders refreshed');
  }, [queryClient]);
  ...
  const refreshApps = useCallback(async (options: SmartRefreshOptions = {}) => {
    ...
    console.log('🔄 [SmartRefresh] Refreshing apps...');
    ...
    console.log('✅ [SmartRefresh] Apps refreshed');
  }, [queryClient]);
  ...
  const refreshAll = useCallback(async (options: SmartRefreshOptions = {}) => {
    ...
    console.log('🔄 [SmartRefresh] Refreshing all data...');
    ...
    console.log('✅ [SmartRefresh] All data refreshed');
  }, [queryClient]);
  ...
  const refreshAfterMutation = useCallback(async (
    ...
    console.log(`🎯 [SmartRefresh] Auto-refresh after ${mutationType} ${dataType}`);
