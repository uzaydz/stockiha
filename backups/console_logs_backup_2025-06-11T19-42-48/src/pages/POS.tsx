...
const POS = () => {
  ...
  const fetchSubscriptions = async () => {
    try {
      ...
      if (user?.user_metadata?.organization_id) {
        ...
        console.log('🏢 Organization ID from user metadata:', currentOrgId);
      }
      
      // الطريقة الثانية: من localStorage
      if (!currentOrgId) {
        currentOrgId = localStorage.getItem('bazaar_organization_id');
        console.log('🏢 Organization ID from localStorage:', currentOrgId);
      }
      ...
      console.log('🏢 Final Organization ID:', currentOrgId);
  ...
  const fetchSubscriptionCategories = async () => {
    try {
      ...
      console.log('🏢 Organization ID for categories:', currentOrgId);
