...
export const prepareFormSubmissionData = (
  ...
  console.log('🔍 [prepareFormSubmissionData] Function called with:', {
    additionalImages,
    additionalImagesCount: additionalImages.length,
    hasAdditionalImages: !!additionalImages
  });
  ...
  console.log('🔍 [prepareFormSubmissionData] Images to submit:', {
    originalImages: additionalImages,
    filteredImages: imagesToSubmit,
    imagesCount: imagesToSubmit.length
  });

  // Debug: فحص بيانات slug
  console.log('🔍 [prepareFormSubmissionData] Slug data:', {
  ...
  console.log('🔍 [prepareFormSubmissionData] Final slug:', finalSlug);
  ...
  console.log('🔍 [prepareFormSubmissionData] Final submission data:', {
    hasAdditionalImages: !!finalData.additional_images,
    additionalImagesCount: finalData.additional_images?.length || 0,
    additionalImages: finalData.additional_images,
