    ...
    try {
      ...
      switch (provider.code.toLowerCase()) {
        ...
        case 'msm_go':
          ...
          break;
        case 'negmar_express':
          providerEnum = ShippingProviderEnum.NEGMAR_EXPRESS;
          break;
        case 'packers':
