    ...
    >
      ...
      {(primaryButtonText || secondaryButtonText) && (
        <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center"> 
          {primaryButtonText && (
            <div className={cn(
              "w-full sm:w-auto text-lg px-8 py-6 h-auto font-semibold rounded-2xl group relative overflow-hidden cursor-default",
          ...
          {secondaryButtonText && (
            <div className={cn(
              "w-full sm:w-auto text-lg px-8 py-6 h-auto font-semibold rounded-2xl group relative overflow-hidden border-2 cursor-default",
              isPreview ? "opacity-80" : "",
              buttonStyles[secondaryButtonStyle]
            )}>
              {/* تأثير الخلفية المتحرك */}
