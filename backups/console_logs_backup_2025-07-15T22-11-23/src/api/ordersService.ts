        ...
        for (const item of orderItems) {
          if (item.product_id) {
            try {
              ...
              if (productError) {
                console.warn(`Warning: Could not get current inventory for product ${item.product_id}:`, productError);
                continue;
              }
              ...
              if (inventoryError) {
                console.warn(`Warning: Could not restore inventory for product ${item.product_id}:`, inventoryError);
