-- ======================================================================
-- دالة موحدة لجلب جميع بيانات الإشتراك والطلبات
...
'دالة موحدة تجلب جميع بيانات الإشتراك والطلبات في استدعاء واحد لتحسين الأداء';

-- ====================
-- اختبار الدالة
-- ====================

-- يمكنك اختبار الدالة بهذا الاستعلام:
-- SELECT get_unified_subscription_data('organization-uuid-here');
