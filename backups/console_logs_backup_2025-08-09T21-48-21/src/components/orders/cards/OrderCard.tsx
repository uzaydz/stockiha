                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-auto p-0 font-bold text-lg text-primary hover:text-primary/80"
                      onClick={() => copyToClipboard(formattedOrderNumber, 'رقم الطلب')}
                    >
                      {formattedOrderNumber}
                      <Copy className="mr-2 h-3 w-3 opacity-60" />
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>انقر لنسخ رقم الطلب</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      onClick={() => copyToClipboard(customerContact, 'معلومات الاتصال')}
                    >
                      {customerContact}
          ...
          <div className="flex items-center gap-2">
            ...
            {hasUpdatePermission && (
              <OrderStatusDropdown
                ...
                onUpdateStatus={(newStatus) => onUpdateStatus(id, newStatus, currentUserId)}
