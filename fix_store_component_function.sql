-- إصلاح وظيفة upsert_store_component التي تظهر خطأ 404
-- هذه الوظيفة تستخدم في واجهة تحرير المتجر إضافة/تحديث مكونات المتجر

-- تحديث وظيفة upsert_store_component لضمان وجودها في قاعدة البيانات
