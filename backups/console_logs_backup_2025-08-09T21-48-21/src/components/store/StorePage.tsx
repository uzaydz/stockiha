...
const StorePage: React.FC<StorePageProps> = () => {
  ...
  useEffect(() => {
    // إذا كان TenantContext ما زال يحمل أو لم تتحدد المؤسسة بعد، أظهر التحميل
  ...
  const isDataReady = !tenantLoading && currentOrganization && (storeInfo || storeName) && !unifiedLoading.shouldShowGlobalLoader;
  
  // إذا لم تكن البيانات جاهزة، لا نعرض أي محتوى لتجنب flash of empty content
  if (!isDataReady) {
    return null; // سيظهر مؤشر التحميل من useEffect أعلاه
  }
