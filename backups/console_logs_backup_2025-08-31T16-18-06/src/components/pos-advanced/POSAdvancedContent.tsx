...
const POSAdvancedContent: React.FC<POSAdvancedContentProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* تبويب المنتجات */}
      <TabsContent value="products" className={cn("mt-0 min-h-0 flex flex-col", filterState.activeTab === 'products' ? 'flex-1' : 'hidden')}>
      ...
      <TabsContent value="subscriptions" className={cn("mt-0 min-h-0", filterState.activeTab === 'subscriptions' ? 'flex-1' : 'hidden')}>
        <SubscriptionsTab
