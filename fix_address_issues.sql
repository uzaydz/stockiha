-- حل المشاكل في جدول العناوين وإجراء معالجة الطلبات

-- 1. تعديل جدول العناوين للسماح بقيمة فارغة لحقل الهاتف
ALTER TABLE addresses 
  ALTER COLUMN phone DROP NOT NULL;

-- 2. إعادة إنشاء وظيفة process_online_order_new لدعم كل الأعمدة المطلوبة
