                  ...
                  <div className="flex flex-col sm:flex-row items-stretch">
                    <div className="flex-1 relative">
                      ...
                      <Input 
                        ...
                        id="subdomain"
                        placeholder="mystore"
                        className="rounded-l-none sm:rounded-l-md sm:rounded-r-none pl-9 font-mono text-left lowercase"
                      />
                    </div>
                    <div className="bg-muted border border-input border-r-0 sm:border-r sm:border-l-0 px-3 py-2 flex items-center text-sm text-muted-foreground rounded-r-md sm:rounded-r-none sm:rounded-l-md rtl:rounded-r-md rtl:rounded-l-none">
                      <span className="whitespace-nowrap">.bazaar.com</span>
                    </div>
                  </div>
                </FormControl>
                <FormMessage />
                <FormDescription>
                  مثال: mystore.bazaar.com - استخدم الأحرف الإنجليزية الصغيرة والأرقام والشرطات فقط
                </FormDescription>
              </FormItem>
            )}
          />
