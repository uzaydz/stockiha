-- إصلاح مشكلة عرض البلديات - نسخة مبسطة ومحددة
-- المشكلة: COALESCE لا يعمل بشكل صحيح في الدالة
...
-- إنشاء دالة محدثة مع تركيز على إصلاح البلديات
...
-- اختبار فوري
SELECT 'تم إصلاح الدالة - استخدمت CASE بدلاً من COALESCE لإصلاح مشكلة البلديات' as status;

-- اختبار سريع
SELECT 
  customer_order_number,
  shipping_address->>'municipality' as municipality_name,
