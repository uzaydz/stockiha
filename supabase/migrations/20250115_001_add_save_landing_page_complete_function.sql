-- Migration: إضافة function لحفظ صفحة الهبوط كاملة
-- التاريخ: 2025-01-15
-- الوصف: إنشاء RPC function لحفظ صفحة الهبوط مع جميع مكوناتها في عملية واحدة
...
-- GRANT EXECUTE ON FUNCTION save_landing_page_complete TO authenticated;
