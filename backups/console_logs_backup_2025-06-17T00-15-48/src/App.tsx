...
setTimeout(() => {
  ...
  const tryEnableInterception = () => {
    ...
    if (isSupabaseReady()) {
      ...
      console.log('✅ Request interception enabled after unified client ready');
    } else if (attempts < 50) {
      setTimeout(tryEnableInterception, 100);
    } else {
      console.warn('⚠️ Timeout waiting for unified client, enabling request interception anyway');
      enableRequestInterception();
    }
  };
