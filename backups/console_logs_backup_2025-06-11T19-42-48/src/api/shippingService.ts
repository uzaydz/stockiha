...
interface CreateOrderParams {
  ...
  TypeColis: number; // 0: Échange (exchange), 1: Livraison (normal delivery)
...
export class EcotrackShippingService extends BaseShippingService {
  ...
  async createShippingOrder(params: CreateOrderParams): Promise<any> {
    try {
      ...
      console.log('🔍 [EcotrackShippingService] Request Body:', JSON.stringify(requestBody, null, 2));
      console.log('🔍 [EcotrackShippingService] API URL:', `${this.baseUrl}/api/v1/create/order`);
      ...
      console.error('❌ [EcotrackShippingService] Error details:', {
