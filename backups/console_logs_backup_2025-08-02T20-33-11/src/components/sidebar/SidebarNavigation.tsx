...
const SidebarNavigation: React.FC<SidebarNavigationProps> = ({
  ...
  useEffect(() => {
    console.log('SidebarNavigation: organizationApps updated:', organizationApps);
    console.log('SidebarNavigation: enabledApps:', enabledApps);
    
    // إضافة تأخير صغير للتأكد من تحديث البيانات
    setTimeout(() => {
      console.log('SidebarNavigation: Data update completed with delay');
    }, 100);
