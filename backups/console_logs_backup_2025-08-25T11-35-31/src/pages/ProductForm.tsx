...
const ProductForm = () => {
  ...
  useEffect(() => {
    ...
    console.log('🔍 [ProductForm] productId from useParams:', productId);
    console.log('🔍 [ProductForm] organizationIdFromTenant:', organizationIdFromTenant);
  }, [productId, organizationIdFromTenant]);

  useEffect(() => {
    console.log('🔍 [ProductForm] useProductFormState result:');
    console.log('🔍 [ProductForm] productColors from state:', productColors);
    console.log('🔍 [ProductForm] productColors.length from state:', productColors?.length || 0);
    console.log('🔍 [ProductForm] hasVariantsState from state:', hasVariantsState);
  }, [productColors, hasVariantsState]);

  useEffect(() => {
    console.log('🔍 [ProductForm] useProductFormInitialization result:');
    console.log('🔍 [ProductForm] isLoadingProduct:', isLoadingProduct);
    console.log('🔍 [ProductForm] isEditMode:', isEditMode);
    console.log('🔍 [ProductForm] initialDataSet:', initialDataSet);
  ...
  useEffect(() => {
    console.log('🔍 [ProductForm] Variants state:');
    console.log('🔍 [ProductForm] watchHasVariants:', watchHasVariants);
    console.log('🔍 [ProductForm] hasVariantsState:', hasVariantsState);
    console.log('🔍 [ProductForm] productColors:', productColors);
    console.log('🔍 [ProductForm] productColors.length:', productColors?.length || 0);
  }, [watchHasVariants, hasVariantsState, productColors]);

  // Debug logging for data passed to ProductFormTabs
  useEffect(() => {
    console.log('🔍 [ProductForm] Data passed to ProductFormTabs:');
    console.log('🔍 [ProductForm] productColors:', productColors);
    console.log('🔍 [ProductForm] watchHasVariants:', watchHasVariants);
    console.log('🔍 [ProductForm] useVariantPrices:', useVariantPrices);
    console.log('🔍 [ProductForm] useSizes:', useSizes);
