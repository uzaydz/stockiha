-- إصلاح عرض أسماء البلديات في دالة get_advanced_online_orders
-- المشكلة: الدالة تعرض معرف البلدية بدلاً من الاسم
...
-- إعادة إنشاء الدالة مع إصلاح مشكلة البلديات
...
BEGIN
    ...
    SELECT 
        ...
        -- معلومات العنوان والتوصيل (إصلاح البلديات هنا)
        CASE 
...
-- اختبار الدالة
SELECT 'تم تحديث الدالة بنجاح - يجب أن تعرض البلديات بأسمائها الآن' as status;

-- اختبار سريع
SELECT 
  customer_order_number,
  shipping_address->>'municipality' as municipality_should_show_name
