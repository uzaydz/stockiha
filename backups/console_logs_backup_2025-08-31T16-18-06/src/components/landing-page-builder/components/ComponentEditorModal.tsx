        ...
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 
                     ...
                     overflow-hidden border flex flex-col"
          >
            {/* Header - الرأس */}
            ...
            >
              <div className="px-5 pt-4 border-b bg-muted/10 flex-shrink-0">
                <TabsList className="w-full bg-muted/60">
                  <TabsTrigger value="settings" className="flex-1 data-[state=active]:bg-background data-[state=active]:text-foreground">{t('الإعدادات')}</TabsTrigger>
                  <TabsTrigger value="style" className="flex-1 data-[state=active]:bg-background data-[state=active]:text-foreground">{t('المظهر')}</TabsTrigger>
                  <TabsTrigger value="advanced" className="flex-1 data-[state=active]:bg-background data-[state=active]:text-foreground">{t('متقدم')}</TabsTrigger>
                </TabsList>
              </div>
