...
export const TenantProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  console.log('🔍 TenantProvider - الحالة الحالية:', {
  ...
  useEffect(() => {
    ...
    const loadTenantData = async () => {
      console.log('🔍 TenantProvider.loadTenantData - بدء التحميل:', {
      ...
      if (loadingOrganization.current || initialized.current) {
        console.log('❌ TenantProvider.loadTenantData - تجنب التحميل المتزامن');
