...
export const createPOSOrder = async (
  ...
  try {
    ...
    const orderData = {
      ...
      total: order.total || 0, // المجموع النهائي بعد الخصم
      notes: order.notes || '',
      is_online: false,
    ...
    // استخدام الإدخال المباشر لدعم معلومات الألوان والمقاسات
    // الدالة المخزنة create_pos_order_safe لا تدعم حفظ معلومات المتغيرات حالياً
    ...
    if (order.items && order.items.length > 0) {
      try {
          ...
          // إضافة حقول الألوان والمقاسات المباشرة
