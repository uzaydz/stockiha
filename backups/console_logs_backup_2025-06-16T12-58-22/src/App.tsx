...
// تفعيل اعتراض الطلبات فوراً لمنع جميع الطلبات المكررة
enableRequestInterception();
console.log('🛡️ تم تفعيل نظام اعتراض الطلبات المكررة!');

// تفعيل النظام الشامل الجديد لمنع الطلبات المكررة
import { enableAuthInterception } from '@/lib/authInterceptorV2';
enableAuthInterception();
console.log('🎯 تم تفعيل النظام الشامل الجديد لمنع الطلبات المكررة!');
