...
export const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      // ✅ Stale time: 1 دقيقة للتحديث السريع والفعال
      staleTime: 1 * 60 * 1000, // 1 minute - محسن من 5 دقائق
      
      // ✅ Cache time: 5 دقائق للذاكرة المحسنة
      gcTime: 5 * 60 * 1000, // 5 minutes - محسن من 30 دقيقة
