      ...
      <div className="container px-6 mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-foreground mb-6">
            انضم إلى <span className="bg-gradient-to-l from-[#fc5d41] via-[#fc5d41]/80 to-[#fc5d41]/60 bg-clip-text text-transparent">عائلة Stockiha</span>
          </h2>
            ...
            {[
              ...
              >
                <div className="relative inline-block mb-4">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#fc5d41]/20 to-[#fc5d41]/20 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        <div className="relative p-4 rounded-2xl bg-white dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 group-hover:border-[#fc5d41]/30 transition-colors">
