...
const ProductPurchaseSummary = memo<ProductPurchaseSummaryProps>(({
  ...
  // تحديد ما إذا كانت بيانات الموقع متوفرة
  const hasLocationData = selectedProvince && selectedMunicipality;
        ...
        <div className="flex justify-between items-center">
          ...
          {isLoadingDeliveryFee ? (
            ...
            <span className="font-medium text-green-600 flex items-center gap-1">
              ...
              <div className="text-sm text-amber-600 font-medium space-y-1">
                <div>اختر الولاية والبلدية لمعرفة سعر التوصيل</div>
                <div className="text-xs">Sélectionnez la wilaya et la commune</div>
                <div className="text-xs">Select province and municipality</div>
              </div>
            )}
        </div>
