...
const ProductActions = memo(({
  ...
  useEffect(() => {
    const observeForm = () => {
      ...
      console.log('🔍 [ProductActions] البحث عن النموذج:', {
        found: !!formElement,
      ...
      if (!formElement) {
        console.log('⚠️ [ProductActions] لم يتم العثور على النموذج - إظهار الزر');
        setIsVisible(true);
        setIsAtForm(false);
        return;
      }
      ...
      const observer = new IntersectionObserver(
        (entries) => {
          entries.forEach((entry) => {
            ...
            console.log('👁️ [ProductActions] حالة النموذج:', {
            ...
            if (isFormVisible) {
              console.log('✅ [ProductActions] النموذج مرئي - إخفاء الزر العائم');
              setIsAtForm(true);
              setIsVisible(false);
            } else {
              console.log('❌ [ProductActions] النموذج غير مرئي - إظهار الزر العائم');
              setIsAtForm(false);
              setIsVisible(true);
            }
          });
  ...
  const handleAction = useCallback(() => {
    ...
    console.log('🎯 [ProductActions] معالج النقر:', {
      hasForm: !!formElement,
      canPurchase,
      buyingNow
    });
    ...
    if (formElement) {
      console.log('📜 [ProductActions] الانتقال للنموذج');
      ...
      console.log('💳 [ProductActions] الشراء المباشر');
