                        ...
                        <div className="space-y-2 pl-4 pr-2">
                          {group.components.map((type) => (
                            <Button
                              ...
                              className="w-full justify-start gap-3 h-12 text-sm hover:bg-primary hover:text-primary-foreground border border-transparent hover:border-primary/20 transition-all duration-200 rounded-lg"
                            >
