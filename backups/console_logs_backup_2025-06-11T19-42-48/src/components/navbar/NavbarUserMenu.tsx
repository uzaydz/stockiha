...
import { ChevronDown, LogOut, Shield, UserCircle, ShoppingBag, Settings, User2, Store, Sparkles } from 'lucide-react';
    ...
    return (
      ...
      >
        <Link to="/login" className="relative z-10">
          ...
          <Sparkles className="h-4 w-4 ml-1 group-hover:rotate-12 transition-transform duration-300" />
          تسجيل الدخول
        </Link>
      </Button>
    );
